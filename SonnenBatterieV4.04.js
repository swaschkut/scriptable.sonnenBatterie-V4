...
const fileManagerMode = 'ICLOUD'; // default is ICLOUD. If you don't use iCloud Drive use option LOCAL9
...
const apiURL3 = "http://" + IP + ":80/api/v2/battery" // CycleCount, CellTemperature
...
async function createWidget(items) {
    ...
    if (apiError == false && catchError == false) {
        ...
        state.stateofhealth = data3.systemstatus
